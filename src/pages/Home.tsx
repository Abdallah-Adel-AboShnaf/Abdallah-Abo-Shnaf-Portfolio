        ...
        <div className="text-center space-y-6 sm:space-y-8 animate-fade-in">
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="space-y-3 sm:space-y-4">
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold text-sky-800 mb-4 sm:mb-6 leading-tight">
                Hi, I'm{' '}
              ...
              <p className="text-xl sm:text-2xl md:text-3xl lg:text-5xl text-sky-600 font-bold mb-6 sm:mb-8 max-w-3xl mx-auto leading-tight">
                <TypeAnimation
                  sequence={[
                    'Data Scientist',
                    1500,
          ...
          <div className="flex flex-col gap-3 sm:gap-4 justify-center items-center px-4">
            <Button 
              size="lg" 
              className="bg-gradient-to-r from-blue-600 to-teal-600 hover:from-blue-700 hover:to-teal-700 text-white w-full sm:w-auto text-sm sm:text-base"
            ...
            <Button
              variant="outline"
              size="lg"
              className="border-slate-300 hover:bg-slate-50 w-full sm:w-auto text-sm sm:text-base"
